...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <form action="{{url('admin/update-faq/'  . $faq->id)}}" method="POST">
            ...
            <div class="col-12 mb-3">
                ...
                placeholder="Enter Question" name="ques" value="{{$faq->ques}}">
            </div>
            ...
            <div class="col-12 mb-4">
                ...
                rows="3" placeholder="Enter Answer" name= "answer" value="{{$faq->answer}}">
            </div>
