...
<div class="card mt-4">
    ...
    <div class="card-body">
        ...
        <form class="row g-2" action="{{url('admin/update-team/'  . $team->id)}}" method="POST" enctype="multipart/form-data">

            @csrf
            @method('PUT')
            <div class="col-12 mb-3">
                <label for="name" class="form-label fw-bold">Name</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Title" name="name" value="{{$team->name}}">
            </div>

            <div class="col-12 mb-3">
                <label for="name" class="form-label fw-bold">Position</label>
                <input type="text" class="form-control" id="name"
                placeholder="Enter Title" name="position" value="{{$team->position}}">
            </div>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control fw-bold" name= "twitter" value="{{$team->twitter}}">
        </div>

        <div class="col-md-6 mb-3">
            <label  for="name" class="form-label fw-bold">Facebook</label>
            <input type="text" class="form-control fw-bold" name= "facebook" value="{{$team->facebook}}">
        </div>

        <div class="col-md-6 mb-3">
            <label  for="name" class="form-label fw-bold">Instagram</label>
            <input type="text" class="form-control fw-bold" name= "instagram" value="{{$team->instagram}}">
        </div>

        <div class="col-md-6 mb-3">
            <label  for="name" class="form-label fw-bold">Linledin</label>
            <input type="text" class="form-control fw-bold" name= "linkedin" value="{{$team->linkedin}}">
        </div>
    <div class=" mb-3">
